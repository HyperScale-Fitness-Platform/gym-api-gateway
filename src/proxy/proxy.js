  ...
  for (const route of routes) {
    ...
    app.use(
      ...
      createProxyMiddleware({
        ...
        // Express removes the mounted prefix before this middleware runs.
        // Most services include their public prefix in their own routes, but
        // catalog-service intentionally exposes /api/products directly.
        pathRewrite: (path) =>
          route.preservePrefix === false ? path : `${route.prefix}${path}`,
